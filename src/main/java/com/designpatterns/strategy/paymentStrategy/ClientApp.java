...
public class ClientApp {
    ...
    static {
        ...
        priceOnProducts.put(3, 1400);
        priceOnProducts.put(4, 800);
        priceOnProducts.put(5, 1250);
    }
    ...
    public static void main(String[] args) throws IOException {
        while(!order.isClosed()) {
            ...
            if(strategy == null) {
                System.out.println("Please, select a payment mthod: " + "\n" +
                "1 - PayPal" + "\n" +
                "2 - Credit Card");
                ...
                System.out.println("Pay " + order.getTotalCost() + " units or Continue shipping? P/C");
                String proceed = reader.readLine();
                if(proceed.equalsIgnoreCase("P")) {
                    if(strategy.pay(order.getTotalCost())) {
                        System.out.println("Payment has beed successfull");
                    } else {
                        System.out.println("FIAL! Plaese, check your data");
                    }
                    order.setClosed();
                }
            }
